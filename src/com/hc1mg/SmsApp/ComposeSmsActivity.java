...
public class ComposeSmsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		toPhoneNumberET = (EditText) findViewById(R.id.et_send_sms_phone_no_);
		smsMessageET = (EditText) findViewById(R.id.editTextSMS);
		addContactButton = (Button) findViewById(R.id.button_send_sms_add_contact);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == RESULT_OK) {
			...
			case CONTACT_PICKER_RESULT:
				final EditText phoneInput = (EditText) findViewById(R.id.et_send_sms_phone_no_);
				Cursor cursor = null;
				String phoneNumber = "";
